#!/usr/bin/env bash
# Exp Setting
export config_path=experiments/configs/cifar10
...
export scripts_path=experiments/scripts/cifar10-extension/${attack_type}-noise/${perturb_type}-noise-${patch_location}-patch${patch_size}
